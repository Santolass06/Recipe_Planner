...
export default function SearchBar({ value, onChange, placeholder = "Pesquisar…", shortcut = "Ctrl+K" }: SearchBarProps) {
  ...
  return (
    <div className="search-bar" role="search" aria-label={placeholder}>
